      ...
      >
        <div className="flex flex-wrap gap-1">
          {selected.map((option) => {
            return (
              <div
                key={option.value}
                className={cn(
                  "animate-fadeIn relative inline-flex h-7 cursor-default items-center rounded-md border bg-accent ps-2 pe-7 pl-2 text-xs font-medium text-accent-foreground transition-all hover:bg-accent disabled:pointer-events-none disabled:cursor-not-allowed disabled:opacity-50 data-fixed:pe-2",
                  badgeClassName
                )}
          ...
          <CommandPrimitive.Input
            ...
            className={cn(
              "flex-1 outline-hidden placeholder:text-muted-foreground/70 disabled:cursor-not-allowed",
              {
